...
class Solution {
    public static ArrayList<ArrayList<Integer>> Paths(Node root) {
        ...
        find(new ArrayList<Integer>(), root, ans);
        return ans;
    }

    public static void find(ArrayList<Integer> store, Node root, ArrayList<ArrayList<Integer>> ans) {
        ...
        if (root.left == null && root.right == null) {
            ...
            ans.add(new ArrayList<>(store)); // Create a new ArrayList to avoid reference issues
        } else {
            // Recursively find paths in the left and right subtrees
            find(store, root.left, ans);
            find(store, root.right, ans);
        }
